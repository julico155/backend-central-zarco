...
import { LogisticsDispatchModule } from '../logistics-dispatch/logistics-dispatch.module';
...
@Module({
  imports: [CommonModule, OperationalSettingsModule, LogisticsDispatchModule],
